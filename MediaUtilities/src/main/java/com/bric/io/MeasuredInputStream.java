...
/**
 * This <code>InputStream</code> relays information from an underlying <code>InputStream</code> while measuring how many
 * bytes have been read or skipped.
 * <P>
...
public class MeasuredInputStream extends InputStream {
	...
	/**
	 * This skips forward to the requested position. If the requested position is less than the current position, then
