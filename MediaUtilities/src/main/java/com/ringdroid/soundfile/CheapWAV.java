...
/**
 * CheapWAV represents a standard 16-bit WAV file, splitting it into artificial frames of 20 ms and taking the maximum
 * of each frame to get an approximation of the waveform contour.
 */
