 ...
 * parsing as little as possible in order to understand the high-level frame structure and get a rough estimate of the
...
public class CheapSoundFile {
	public interface ProgressListener {
		/**
		 * Will be called by the CheapSoundFile subclass periodically with values between 0.0 and 1.0. Return true to
		 * continue loading the file, and false to cancel.
		 */
	...
	/**
	 * Return the filename extensions that are recognized by one of our subclasses.
	 */
	public static String[] getSupportedExtensions() {
		return sSupportedExtensions.toArray(new String[sSupportedExtensions.size()]);
	}
	...
	/**
	 * If and only if this particular file format supports seeking directly into the middle of the file without reading
	 * the rest of the header, this returns the byte offset of the given frame, otherwise returns -1.
	 */
