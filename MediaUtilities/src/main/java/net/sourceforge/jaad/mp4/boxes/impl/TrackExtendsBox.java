...
/**
 * This box sets up default values used by the movie fragments. By setting defaults in this way, space and complexity
...
public class TrackExtendsBox extends FullBox {
	...
	public void decode(MP4InputStream in) throws IOException {
		...
		/*
		 * 6 bits reserved 2 bits sampleDependsOn 2 bits sampleIsDependedOn 2 bits sampleHasRedundancy 3 bits
		 * samplePaddingValue 1 bit sampleIsDifferenceSample 16 bits sampleDegradationPriority
		 */
		defaultSampleFlags = in.readBytes(4);
	}

	/**
	 * The track ID identifies the track; this shall be the track ID of a track in the Movie Box.
	 * 
	 * @return the track ID
	 */
	...
	/**
	 * The default 'sample depends on' value as defined in the SampleDependencyTypeBox.
	 * 
	...
	/**
	 * The default 'sample is depended on' value as defined in the SampleDependencyTypeBox.
	 * 
	...
	/**
	 * The default 'sample has redundancy' value as defined in the SampleDependencyBox.
	 * 
