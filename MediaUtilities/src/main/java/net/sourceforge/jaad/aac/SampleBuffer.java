...
public class SampleBuffer {
	...
	/**
	 * Returns the length of the current frame in seconds. length = samplesPerChannel / sampleRate
	 * 
	 ...
	 * 
	 * @param bigEndian if true the data will be in big endian, else in little endian
	 */
