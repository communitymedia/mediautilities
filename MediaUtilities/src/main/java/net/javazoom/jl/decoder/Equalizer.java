...
/**
 * The <code>Equalizer</code> class can be used to specify equalization settings for the MPEG audio decoder.
 * <p>
 * The equalizer consists of 32 band-pass filters. Each band of the equalizer can take on a fractional value between
 * -1.0 and +1.0. At -1.0, the input signal is attenuated by 6dB, at +1.0 the signal is amplified by 6dB.
 * 
 * @see Decoder
 * 
 * @author MDM
...
public final class Equalizer {
	...
	/**
	 * Sets the bands of this equalizer to the value the bands of another equalizer. Bands that are not present in both
	 * equalizers are ignored.
	 */
	...
	/**
	 * Retrieves an array of floats whose values represent a scaling factor that can be applied to linear samples in
	 * each band to provide the equalization represented by this instance.
	 * 
	...
	/**
	 * Converts an equalizer band setting to a sample factor. The factor is determined by the function f = 2^n where n
	 * is the equalizer band setting in the range [-1.0,1.0].
	 * 
	 */
