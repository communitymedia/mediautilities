...
class LayerIDecoder implements FrameDecoder {
	...
	static abstract class Subband {
		/*
		 * Changes from version 1.1 to 1.2: - array size increased by one, although a scalefactor with index 63 is
		 * illegal (to prevent segmentation faults)
		 */
	...
	/**
	 * Class for layer I subbands in single channel mode. Used for single channel mode and in derived class for
	...
	static class SubbandLayer1 extends Subband {
		...
		public static final float table_factor[] = { 0.0f, (1.0f / 2.0f) * (4.0f / 3.0f),
				(1.0f / 4.0f) * (8.0f / 7.0f), (1.0f / 8.0f) * (16.0f / 15.0f), (1.0f / 16.0f) * (32.0f / 31.0f),
