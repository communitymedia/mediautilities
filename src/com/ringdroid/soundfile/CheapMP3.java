...
public class CheapMP3 extends CheapSoundFile {
	...
	/**
	 * MP3 supports seeking into the middle of the file, no header needed, so this method is supported to hear exactly
	 * what a "cut" of the file sounds like without needing to actually save a file to disk first.
	 */
