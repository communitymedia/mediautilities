...
public class SoundMediaInformationHeaderAtom extends LeafAtom {
	...
	int flags = 0;
	/**
	 * A 16-bit integer that specifies the sound balance of this sound media. Sound balance is the setting that controls
	 * the mix of sound between the two speakers of a computer. This field is normally set to 0.
	 */
	int balance = 0;
