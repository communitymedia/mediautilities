...
public final class PerspectiveTransform implements Cloneable, Serializable {
	...
	private static final long serialVersionUID = 4828143666131015865L;
	...
	private static final void getSquareToQuad(double x0, double y0, double x1, double y1, double x2, double y2,
			double x3, double y3, PerspectiveTransform tx) {
	 ...
	 * </pre>
	 */
	public static PerspectiveTransform getSquareToQuad(double x0, double y0, double x1, double y1, double x2,
	 ...
	 * </pre>
	 */
	public static PerspectiveTransform getSquareToQuad(float x0, float y0, float x1, float y1, float x2, float y2,
			float x3, float y3) {
	 ...
	 * </pre>
	 */
	public static PerspectiveTransform getQuadToSquare(double x0, double y0, double x1, double y1, double x2,
			double y2, double x3, double y3) {
		PerspectiveTransform tx = new PerspectiveTransform();
		getSquareToQuad(x0, y0, x1, y1, x2, y2, x3, y3, tx);
		tx.makeAdjoint();
	 ...
	 * </pre>
	 */
	public static PerspectiveTransform getQuadToSquare(float x0, float y0, float x1, float y1, float x2, float y2,
			float x3, float y3) {
	 ...
	 * </pre>
	 */
	public static PerspectiveTransform getQuadToQuad(double x0, double y0, double x1, double y1, double x2, double y2,
			double x3, double y3, double x0p, double y0p, double x1p, double y1p, double x2p, double y2p, double x3p,
			double y3p) {
	 ...
	 * </pre>
	 */
	public static PerspectiveTransform getQuadToQuad(float x0, float y0, float x1, float y1, float x2, float y2,
	...
	public boolean isIdentity() {
		return m01 == 0.0 && m02 == 0.0 && m10 == 0.0 && m12 == 0.0 && m20 == 0.0 && m21 == 0.0 && m22 != 0.0
	...
	public boolean equals(Object obj) {
		...
		return ((m00 == a.m00) && (m10 == a.m10) && (m20 == a.m20) && (m01 == a.m01) && (m11 == a.m11)
				&& (m21 == a.m21) && (m02 == a.m02) && (m12 == a.m12) && (m22 == a.m22));
	}
}
