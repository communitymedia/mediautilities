...
public class SoundSampleDescriptionEntry0 extends SampleDescriptionEntry {
	 ...
	 * 16. Formats using more than 16 bits per sample set this field to 16 and use sound description version1.
	 */
	int sampleBitSize;

	/**
	 * A 16-bit integer that must be set to 0 for version 0 sound descriptions. This may be set to Ð2 for some version 1
	 * sound descriptions.
	 */
	int compressionID;
	...
	public SoundSampleDescriptionEntry0(String type, int dataReference, int version, int revision, int vendor,
			int channelCount, int sampleBitSize, int compressionID, int packetSize, float sampleRate) {
	...
	public String toString() {
		return "SoundSampleDescriptionEntry0[ type = \"" + type + "\", dataRef = " + dataReference + ", version = "
				...
				+ ", sampleBitSize = " + sampleBitSize + ", compressionID = " + compressionID + ", packetSize = "
				+ packetSize + ", sampleRate = " + sampleRate + "]";
	}
