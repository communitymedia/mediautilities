 ...
 * @(#)SampleSizeAtom.java
 *
 * $Date: 2012-02-06 05:32:40 +0000 (Mon, 06 Feb 2012) $
 *
...
public class SampleSizeAtom extends LeafAtom {
	...
	public String toString() {
		...
		return "SampleSizeAtom[ version=" + version + ", " + "flags=" + flags + ", " + "sampleSize=" + sampleSize
				+ ", sampleCount = " + sampleCount + ", " + "sizeTable=" + entriesString + "]";
	}
}
