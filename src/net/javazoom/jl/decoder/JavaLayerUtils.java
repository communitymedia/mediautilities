...
/**
 * The JavaLayerUtils class is not strictly part of the JavaLayer API. It serves to provide useful methods and
 * system-wide hooks.
 * 
 * @author MDM
 */
public class JavaLayerUtils {
	 ...
	 */
	static public <T> Object deserialize(InputStream in, Class<T> cls) throws IOException {
		if (cls == null)
	...
	/**
	 * Deserializes an object from the given <code>InputStream</code>. The deserialization is delegated to an <code>
	 ...
	 * @exception IOException is thrown if there was a problem reading the underlying stream, or an object could not be
	 ...
	 */
	static public <T> Object deserializeArray(InputStream in, Class<T> elemType, int length) throws IOException {
		if (elemType == null)
	...
	static public <T> Object deserializeArrayResource(String name, Class<T> elemType, int length) throws IOException {
	...
	static public void serialize(OutputStream out, Object obj) throws IOException {
		if (out == null)
	 ...
	 * 
	 * @param name The name of the resource. This must be a simple name, and not a qualified package name.
	 * 
	 * @return The InputStream for the named resource, or null if the resource has not been found. If a hook has been
	 *         provided, its getResourceAsStream() method is called to retrieve the resource.
	 */
