...
final class HuffmanCodeTables {
	...
	private static int ValTab2[][] = { { 2, 1 }, { 0, 0 }, { 4, 1 }, { 2, 1 }, { 0, 16 }, { 0, 1 }, { 2, 1 },
			{ 0, 17 }, { 4, 1 }, { 2, 1 }, { 0, 32 }, { 0, 33 }, { 2, 1 }, { 0, 18 }, { 2, 1 }, { 0, 2 }, { 0, 34 }, };

	private static int ValTab3[][] = { { 4, 1 }, { 2, 1 }, { 0, 0 }, { 0, 1 }, { 2, 1 }, { 0, 17 }, { 2, 1 },
			{ 0, 16 }, { 4, 1 }, { 2, 1 }, { 0, 32 }, { 0, 33 }, { 2, 1 }, { 0, 18 }, { 2, 1 }, { 0, 2 }, { 0, 34 }, };

	private static int ValTab4[][] = { { 0, 0 } }; // dummy

	private static int ValTab5[][] = { { 2, 1 }, { 0, 0 }, { 4, 1 }, { 2, 1 }, { 0, 16 }, { 0, 1 }, { 2, 1 },
			{ 0, 17 }, { 8, 1 }, { 4, 1 }, { 2, 1 }, { 0, 32 }, { 0, 2 }, { 2, 1 }, { 0, 33 }, { 0, 18 }, { 8, 1 },
			{ 4, 1 }, { 2, 1 }, { 0, 34 }, { 0, 48 }, { 2, 1 }, { 0, 3 }, { 0, 19 }, { 2, 1 }, { 0, 49 }, { 2, 1 },
			{ 0, 50 }, { 2, 1 }, { 0, 35 }, { 0, 51 }, };

	private static int ValTab6[][] = { { 6, 1 }, { 4, 1 }, { 2, 1 }, { 0, 0 }, { 0, 16 }, { 0, 17 }, { 6, 1 },
	...
	private static int ValTab8[][] = { { 6, 1 }, { 2, 1 }, { 0, 0 }, { 2, 1 }, { 0, 16 }, { 0, 1 }, { 2, 1 },
	...
	private static int ValTab9[][] = { { 8, 1 }, { 4, 1 }, { 2, 1 }, { 0, 0 }, { 0, 16 }, { 2, 1 }, { 0, 1 },
	...
	private static int ValTab11[][] = { { 6, 1 }, { 2, 1 }, { 0, 0 }, { 2, 1 }, { 0, 16 }, { 0, 1 }, { 8, 1 },
	...
	private static int ValTab33[][] = { { 16, 1 }, { 8, 1 }, { 4, 1 }, { 2, 1 }, { 0, 0 }, { 0, 1 }, { 2, 1 },
			{ 0, 2 }, { 0, 3 }, { 4, 1 }, { 2, 1 }, { 0, 4 }, { 0, 5 }, { 2, 1 }, { 0, 6 }, { 0, 7 }, { 8, 1 },
			{ 4, 1 }, { 2, 1 }, { 0, 8 }, { 0, 9 }, { 2, 1 }, { 0, 10 }, { 0, 11 }, { 4, 1 }, { 2, 1 }, { 0, 12 },
			{ 0, 13 }, { 2, 1 }, { 0, 14 }, { 0, 15 }, };

	public static HuffmanCodeTables[] ht = null; /* Simulate extern struct */
	 ...
	 */
	private HuffmanCodeTables(String S, int XLEN, int YLEN, int LINBITS, int LINMAX, int REF, int[] TABLE, int[] HLEN,
			int[][] VAL, int TREELEN) {
	 ...
	 */
	public static int huffman_decoder(HuffmanCodeTables h, int[] x, int[] y, int[] v, int[] w, BitReserve br) {
		...
		/*
		 * int bitsAvailable = 0; int bitIndex = 0; int bits[] = bitbuf;
		 */
		do {
	...
	public static void inithuff() {
		...
		ht = new HuffmanCodeTables[HTN];
		ht[0] = new HuffmanCodeTables("0  ", 0, 0, 0, 0, -1, null, null, ValTab0, 0);
		ht[1] = new HuffmanCodeTables("1  ", 2, 2, 0, 0, -1, null, null, ValTab1, 7);
		ht[2] = new HuffmanCodeTables("2  ", 3, 3, 0, 0, -1, null, null, ValTab2, 17);
		ht[3] = new HuffmanCodeTables("3  ", 3, 3, 0, 0, -1, null, null, ValTab3, 17);
		ht[4] = new HuffmanCodeTables("4  ", 0, 0, 0, 0, -1, null, null, ValTab4, 0);
		ht[5] = new HuffmanCodeTables("5  ", 4, 4, 0, 0, -1, null, null, ValTab5, 31);
		ht[6] = new HuffmanCodeTables("6  ", 4, 4, 0, 0, -1, null, null, ValTab6, 31);
		ht[7] = new HuffmanCodeTables("7  ", 6, 6, 0, 0, -1, null, null, ValTab7, 71);
		ht[8] = new HuffmanCodeTables("8  ", 6, 6, 0, 0, -1, null, null, ValTab8, 71);
		ht[9] = new HuffmanCodeTables("9  ", 6, 6, 0, 0, -1, null, null, ValTab9, 71);
		ht[10] = new HuffmanCodeTables("10 ", 8, 8, 0, 0, -1, null, null, ValTab10, 127);
		ht[11] = new HuffmanCodeTables("11 ", 8, 8, 0, 0, -1, null, null, ValTab11, 127);
		ht[12] = new HuffmanCodeTables("12 ", 8, 8, 0, 0, -1, null, null, ValTab12, 127);
		ht[13] = new HuffmanCodeTables("13 ", 16, 16, 0, 0, -1, null, null, ValTab13, 511);
		ht[14] = new HuffmanCodeTables("14 ", 0, 0, 0, 0, -1, null, null, ValTab14, 0);
		ht[15] = new HuffmanCodeTables("15 ", 16, 16, 0, 0, -1, null, null, ValTab15, 511);
		ht[16] = new HuffmanCodeTables("16 ", 16, 16, 1, 1, -1, null, null, ValTab16, 511);
		ht[17] = new HuffmanCodeTables("17 ", 16, 16, 2, 3, 16, null, null, ValTab16, 511);
		ht[18] = new HuffmanCodeTables("18 ", 16, 16, 3, 7, 16, null, null, ValTab16, 511);
		ht[19] = new HuffmanCodeTables("19 ", 16, 16, 4, 15, 16, null, null, ValTab16, 511);
		ht[20] = new HuffmanCodeTables("20 ", 16, 16, 6, 63, 16, null, null, ValTab16, 511);
		ht[21] = new HuffmanCodeTables("21 ", 16, 16, 8, 255, 16, null, null, ValTab16, 511);
		ht[22] = new HuffmanCodeTables("22 ", 16, 16, 10, 1023, 16, null, null, ValTab16, 511);
		ht[23] = new HuffmanCodeTables("23 ", 16, 16, 13, 8191, 16, null, null, ValTab16, 511);
		ht[24] = new HuffmanCodeTables("24 ", 16, 16, 4, 15, -1, null, null, ValTab24, 512);
		ht[25] = new HuffmanCodeTables("25 ", 16, 16, 5, 31, 24, null, null, ValTab24, 512);
		ht[26] = new HuffmanCodeTables("26 ", 16, 16, 6, 63, 24, null, null, ValTab24, 512);
		ht[27] = new HuffmanCodeTables("27 ", 16, 16, 7, 127, 24, null, null, ValTab24, 512);
		ht[28] = new HuffmanCodeTables("28 ", 16, 16, 8, 255, 24, null, null, ValTab24, 512);
		ht[29] = new HuffmanCodeTables("29 ", 16, 16, 9, 511, 24, null, null, ValTab24, 512);
		ht[30] = new HuffmanCodeTables("30 ", 16, 16, 11, 2047, 24, null, null, ValTab24, 512);
		ht[31] = new HuffmanCodeTables("31 ", 16, 16, 13, 8191, 24, null, null, ValTab24, 512);
		ht[32] = new HuffmanCodeTables("32 ", 1, 16, 0, 0, -1, null, null, ValTab32, 31);
		ht[33] = new HuffmanCodeTables("33 ", 1, 16, 0, 0, -1, null, null, ValTab33, 31);
	}
}
