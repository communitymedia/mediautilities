...
public abstract class SampleEntry extends BoxImpl {
	...
	/**
	 * The data reference index is an integer that contains the index of the data reference to use to retrieve data
	 * associated with samples that use this sample description. Data references are stored in Data Reference Boxes. The
