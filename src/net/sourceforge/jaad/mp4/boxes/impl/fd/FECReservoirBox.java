...
/**
 * The FEC reservoir box associates the source file identified in the file partition box with FEC reservoirs stored as
 * additional items. It contains a list that starts with the first FEC reservoir associated with the first source block
 * of the source file and continues sequentially through the source blocks of the source file.
 * 
 * @author in-somnia
 */
