...
class HFAdjuster implements SBRConstants, NoiseTable {
	...
	private static final double[] SMOOTHING_FACTORS = { 0.33333333333333, 0.30150283239582, 0.21816949906249,
			0.11516383427084, 0.03183050093751 };
	private static final int[][] PHI = { { 1, 0, -1, 0 }, { 0, 1, 0, -1 } };
	...
	public static void process(SBRHeader header, FrequencyTables tables, ChannelData cd, float[][][] Xhigh,
			float[][][] Y) {
	...
	private static float[][] estimateEnvelopes(SBRHeader header, FrequencyTables tables, ChannelData cd,
			float[][][] Xhigh) {
	...
	private static void assembleSignals(SBRHeader header, FrequencyTables tables, ChannelData cd, Parameter p,
			float[][][] Xhigh, float[][][] Y) {
