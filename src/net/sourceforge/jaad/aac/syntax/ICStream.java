...
public class ICStream implements Constants, HCB, ScaleFactorTable, IQTable {
	...
	/* =========== gets ============ */
	/**
	 * Does inverse quantization and applies the scale factors on the decoded data. After this the noiseless decoding is
	 * finished and the decoded data is returned.
	 * 
